...
function generateJS(ast, options) {
  ...
  function generateRuleFunction(rule) {
    ...
    var ruleDescEsc = rule.expression.name != null ?
        "\"" + js.stringEscape(rule.expression.name) + "\"" : null;
    ...
    if (options.trace) {
      if (options.optimize === "size") {
        let ruleNames = "["
                  ...
                  + "]";
        let descNamesArrStr = "["
                  + ast.rules.map(({ expression }) => {
                      return expression.name != null ? "\"" + js.stringEscape(expression.name) + "\"" : "null";
                    }).join(", ")
                  + "]";
        parts.push([
          "  var peg$ruleNames = " + ruleNames + ";",
          "  var peg$descNames = " + descNamesArrStr + ";",
          ""
        ].join("\n"));
      }
