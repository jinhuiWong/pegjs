  ...
  function generateRuleHeader(ruleNameCode, ruleIndexCode) {
    ...
    if (options.trace) {
      parts.push([
        ...
        '  type:     "rule.enter",',
        '  rule:     ' + ruleNameCode + ',',
        '  description: peg$descNames[' + ruleNameCode + '],',
  ...
  if (options.trace) {
    descNames = '{'
              + arrays.map(
                  ast.rules,
                  function(r) {
                    var prop = '"' + js.stringEscape(r.name) + '": ',
                        val = (r.hasOwnProperty('expression') &&
                                r.expression.hasOwnProperty('name') ?
                                  '"' + js.stringEscape(r.expression.name)  + '"' :
                                  'null');
                    return prop + val;
                  }
                ).join(', ')
